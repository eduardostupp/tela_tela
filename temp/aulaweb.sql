...
--
-- Host: 127.0.0.1
-- Tempo de geração: 12-Nov-2021 às 19:44
...
(2, 15567, 'Agronômica', 1),
(3, 12234, 'Santa Maria', 2),
(4, 0, 'São Paulo', 1),
(7, 873465, 'Florianópolis', 1);
...
INSERT INTO `produtos` (`id`, `marca`, `nome`, `quantidade`, `valorunitario`) VALUES
(1, 'Tauros', 'Pistolão', 10, 1235.98);
